...
export function makeDemoState(): AppState {
  ...
  const organizations = [
    {
      ...
      legalForm: 'ip' as const,
      name: 'ИП Григорьева Ольга Леонидовна',
      status: 'active' as const,
      createdAt: now,
    },
    {
      ...
      ownerUserId: 'local-owner',
      legalForm: 'ip' as const,
      name: 'ИП Леонтьев Михаил Александрович',
      status: 'active' as const,
      createdAt: now,
    },
  ]
  ...
  const businessUnits = [
    {
      id: 'unit-olga-retail',
      organizationId: 'org-olga',
      name: 'Розничный магазин — Невский проспект 100',
      type: 'retail_store' as const,
      address: 'Санкт-Петербург, Невский проспект, 100',
      taxRegistrationIds: ['tax-olga-psn'],
      active: true,
    },
    {
      id: 'unit-olga-other',
      organizationId: 'org-olga',
      name: 'Прочие продажи — УСН 6%',
      type: 'online_store' as const,
      taxRegistrationIds: ['tax-olga-usn'],
      active: true,
    },
    {
      id: 'unit-mikhail-retail',
      organizationId: 'org-mikhail',
      name: 'Розничный магазин — Балтийский бульвар 4',
      type: 'retail_store' as const,
      address: 'Санкт-Петербург, Балтийский бульвар, 4',
      taxRegistrationIds: ['tax-mikhail-psn'],
      active: true,
    },
    {
      id: 'unit-mikhail-marketplaces',
      organizationId: 'org-mikhail',
      name: 'Маркетплейсы / интернет / опт — УСН 6%',
      type: 'online_store' as const,
      taxRegistrationIds: ['tax-mikhail-usn'],
      active: true,
    },
  ]
  ...
  const salesChannels = [
    {
      id: 'ch-olga-retail',
      organizationId: 'org-olga',
      businessUnitId: 'unit-olga-retail',
      type: 'retail' as const,
      name: 'Розничная касса',
    ...
    },
    {
      id: 'ch-olga-usn',
      organizationId: 'org-olga',
      businessUnitId: 'unit-olga-other',
    ...
    {
      id: 'ch-mikhail-retail',
      organizationId: 'org-mikhail',
      businessUnitId: 'unit-mikhail-retail',
      type: 'retail' as const,
      name: 'Розничная касса',
      sourceType: 'cash_register' as const,
      active: true,
    },
    {
      id: 'ch-mikhail-wb',
      organizationId: 'org-mikhail',
      businessUnitId: 'unit-mikhail-marketplaces',
  ...
  const stores = [
    {
      id: 'olga-psn',
      name: 'Григорьева — розница (ПСН)',
      legalForm: 'ip' as const,
      organizationId: 'org-olga',
      taxRegistrationId: 'tax-olga-psn',
      businessUnitId: 'unit-olga-retail',
      regime: 'psn' as const,
      insurancePremiums: 0,
      hasEmployees: false,
      patentCost: PATENT_2026.cost,
      patentPotentialIncome: PATENT_2026.potentialIncome,
      vatMode: 'exempt' as const,
    },
    {
      id: 'olga-usn',
      name: 'Григорьева — УСН 6%',
      legalForm: 'ip' as const,
      organizationId: 'org-olga',
      taxRegistrationId: 'tax-olga-usn',
      businessUnitId: 'unit-olga-other',
      regime: 'usn6' as const,
      insurancePremiums: 0,
      hasEmployees: false,
    ...
    {
      id: 'mikhail-psn',
      name: 'Леонтьев — розница (ПСН)',
      legalForm: 'ip' as const,
      organizationId: 'org-mikhail',
      taxRegistrationId: 'tax-mikhail-psn',
      businessUnitId: 'unit-mikhail-retail',
      regime: 'psn' as const,
      insurancePremiums: 0,
      hasEmployees: false,
    ...
    {
      id: 'mikhail-usn',
      name: 'Леонтьев — маркетплейсы / интернет / опт (УСН 6%)',
      legalForm: 'ip' as const,
      organizationId: 'org-mikhail',
      taxRegistrationId: 'tax-mikhail-usn',
      businessUnitId: 'unit-mikhail-marketplaces',
      regime: 'usn6' as const,
      insurancePremiums: 0,
      hasEmployees: false,
  ...
  for (let monthsAgo = 5; monthsAgo >= 0; monthsAgo--) {
    ...
    for (let i = 0; i < 24; i++) {
      ...
      ops.push({
        ...
        businessUnitId: 'unit-mikhail-marketplaces',
        taxRegistrationId: 'tax-mikhail-usn',
        channelId: mp === 'wb' ? 'ch-mikhail-wb' : 'ch-mikhail-ozon',
